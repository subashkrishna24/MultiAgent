...
================================================================================
1. **PREFIX RULE:** Every assistant reply or question inside this workflow must explicitly start with "Send whatsapp for lead " (e.g., "Send whatsapp for lead, what is the template name?").
...
- Check history. If missing, ask: "Send whatsapp for lead, do you already have a template in mind, or would you like me to show the available templates?"
